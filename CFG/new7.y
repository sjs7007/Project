...
temp:
	 BLOCK { cout <<"bison found a block : "<<$1<<" with following GOTO : " <<endl; }
	| temp BLOCK { cout <<"bison found a block : "<<$2 <<endl; }
	| temp goto  BLOCK { cout<<"bison found a block : "<<$3 <<" with following GOTOs :- " <<endl; }
	;

goto:
	goto GOTO { cout <<"GOTO : "<<$2 <<endl; }
